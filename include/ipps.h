...
IPPAPI(IppStatus, ippsSortRadixIndexAscend_32f, (const Ipp32f * const pSrc, Ipp32s srcStrideBytes,
                                                Ipp32s *pDstIndx, int len, Ipp8u *pBuffer))
...
IPPAPI(IppStatus, ippsNormalize_64fc_I,(Ipp64fc* pSrcDst,
       int len, Ipp64fc vsub, Ipp64f vdiv))
IPPAPI(IppStatus, ippsNormalize_32fc_I,(Ipp32fc* pSrcDst,
       int len, Ipp32fc vsub, Ipp32f vdiv))
IPPAPI(IppStatus, ippsNormalize_16sc_ISfs,(Ipp16sc* pSrcDst,
...
IPPAPI(IppStatus, ippsNormalize_64f_I,(Ipp64f* pSrcDst, int len,
       Ipp64f vSub, Ipp64f vDiv))
IPPAPI(IppStatus, ippsNormalize_32f_I,(Ipp32f* pSrcDst, int len,
       Ipp32f vSub, Ipp32f vDiv))
IPPAPI(IppStatus, ippsNormalize_16s_ISfs,(Ipp16s* pSrcDst,
...
IPPAPI ( IppStatus, ippsConvBiased_32f,
                    ( const Ipp32f *pSrc1, int src1Len,
                      const Ipp32f *pSrc2, int src2Len,
                            Ipp32f *pDst, int dstLen, int bias ))
...
IPPAPI( IppStatus, ippsFIRLMSGetStateSize_32f,(
           int tapsLen, int dlyIndex, int* pBufferSize))

IPPAPI( IppStatus, ippsFIRLMSGetStateSize32f_16s,(
           int tapsLen, int dlyIndex, int* pBufferSize))

IPPAPI( IppStatus, ippsFIRLMSInit_32f,(
    IppsFIRLMSState_32f** ppState, const Ipp32f* pTaps, int tapsLen,
    const Ipp32f *pDlyLine, int dlyIndex, Ipp8u* pBuffer ))

IPPAPI( IppStatus, ippsFIRLMSInit32f_16s,(
    IppsFIRLMSState32f_16s** ppState, const Ipp32f* pTaps, int tapsLen,
    const Ipp16s *pDlyLine, int dlyIndex, Ipp8u* pBuffer ))
...
IPPAPI( IppStatus, ippsFIRSparseInit_32f,( IppsFIRSparseState_32f** ppState,
...
IPPAPI( IppStatus, ippsIIRSparseInit_32f,( IppsIIRSparseState_32f** ppState,
...
IPPAPI( IppStatus, ippsIIRIIRInit64f_32f,( IppsIIRState64f_32f** pState,
         const Ipp64f* pTaps, int order, const Ipp64f* pDlyLine, Ipp8u* pBuf ))
...
IPPAPI( IppStatus, ippsIIRIIR64f_32f,( const Ipp32f *pSrc, Ipp32f *pDst, int len,
                                                    IppsIIRState64f_32f *pState ))
IPPAPI( IppStatus, ippsIIRIIR64f_32f_I,( Ipp32f *pSrcDst, int len,
                                                    IppsIIRState64f_32f *pState ))
...
IPPAPI( IppStatus, ippsIIRIIRGetDlyLine64f_32f,( const IppsIIRState64f_32f *pState,
                                                            Ipp64f *pDlyLine ))
IPPAPI( IppStatus, ippsIIRIIRSetDlyLine64f_32f,( IppsIIRState64f_32f *pState,
